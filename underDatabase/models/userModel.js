...
import Products2 from "./userSchema.js";
...
//     const result = await Products2.insertMany(newProducts);
...
//     const updateResult = await Products2.updateMany(
...
//     const updatedDocuments = await Products2.find({ title: title });
